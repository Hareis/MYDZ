...
namespace MYDZ.Business
{
    internal class Comm
    {
        ...
        /// </summary>
        /// <param name="Order">订单信息</param>
        public static bool InsertOrderList(List<tbOrdersInfo> ListOrders)
        {
            bool result = false;
            List<tbOrdersDetail> listOrdersDetail = new List<tbOrdersDetail>();
            List<tbBuyerInfo> listtbBuyerInfo = new List<tbBuyerInfo>();
            List<tbConsigneeInfo> listConsigneeInfo = new List<tbConsigneeInfo>();
            try
            {
                foreach (tbOrdersInfo OrdersInfo in ListOrders)
                {
                    //为订单添加编号
                    if (OrdersInfo != null)
                    {
                    ...
                    listOrdersDetail.AddRange(OrdersInfo.Details);

                    OrdersInfo.Buyer.OrdersNumber = OrdersInfo.OrdersOutNumber;
                    listtbBuyerInfo.Add(OrdersInfo.Buyer);

                    listConsigneeInfo.Add(OrdersInfo.Consignee);
                }
                using (TransactionScope ts = new TransactionScope())
                {
                    ...
                    {
                        //添加主订单
                        MYDZ.Business.DataBase_BLL.Order.OrdersInfo.InsertListOrdersInfo(ListOrders);

                        //添加买家信息
                        MYDZ.Business.DataBase_BLL.Order.BuyerInfo.InsertListBuyerInfo(listtbBuyerInfo);

                        //添加收货信息
                        MYDZ.Business.DataBase_BLL.Order.ConsigneeInfo.InsertListConsigneeInfo(listConsigneeInfo);

                        //添加子订单
                        MYDZ.Business.DataBase_BLL.Order.OrdersDetail.InsertListOrdersDetail(listOrdersDetail);

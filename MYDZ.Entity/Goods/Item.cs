...
{
    [Serializable]
    public class Item : Response
    {
        /// <summary>
        /// 数据库ID
        /// </summary>
        [XmlElement("ItemImgID")]
        ...
        /// </summary>
        [XmlElement("SPZL")]
        public int SPZL { get; set; }

        /// <summary>
        /// 商品简称
        /// </summary>
        [XmlElement("SPJC")]
        public int SPJC { get; set; }
        ...
        ///fields中只设置sku可以返回Sku结构体中所有字段，如果设置为sku.sku_id、sku.properties、sku.quantity等形式就只会返回相应的字段
        /// </summary>
        [XmlArray("skus")]
        [XmlArrayItem("sku")]

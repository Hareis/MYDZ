...
namespace MYDZ.Entity.Order
{
    ...
    /// 交易请求类 （创建时间）
    /// </summary>
    public class TradesSoldGet : Response
    {
        /// <summary>
        /// 订单编号
        /// </summary>
